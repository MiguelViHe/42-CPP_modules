...
/*   Updated: 2025/08/07 13:13:37 by mvidal-h         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Sign = (" << p1.getX().toFloat() << " - " << p3.getX().toFloat() 
				<< ") * (" << p2.getY().toFloat() << " - " << p3.getY().toFloat() 
				<< ") - (" << p2.getX().toFloat() << " - " << p3.getX().toFloat() 
				<< ") * (" << p1.getY().toFloat() << " - " << p3.getY().toFloat() 
				<< ") = " 
				<< (p1.getX().toFloat() - p3.getX().toFloat()) * (p2.getY().toFloat() - p3.getY().toFloat())
		 - (p2.getX().toFloat() - p3.getX().toFloat()) * (p1.getY().toFloat() - p3.getY().toFloat()) << std::endl;
